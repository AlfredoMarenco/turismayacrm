<x-guest-layout>
    ...
    <div class="flex h-screen flex-col justify-center py-12 sm:px-6 lg:px-8 bg-blue-900">
        <div class="sm:mx-auto sm:w-full sm:max-w-md">
            <img class="mx-auto h-12 w-auto" src="/img/turismaya-logo.svg" alt="Your Company">
        ...
        <div class="mt-8 sm:mx-auto sm:w-full sm:max-w-md">
            <div class="bg-white py-8 px-4 shadow sm:rounded-lg sm:px-10">
                ...
                <form class="space-y-6" method="POST" action="{{ route('login') }}">
                    ...
                    <div>
                        <button type="submit"
                            class="flex w-full justify-center rounded-md border border-transparent bg-blue-900 py-2 px-4 text-sm font-medium text-white shadow-sm hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2">Iniciar
                            sesión</button>
                    </div>
                </form>
            </div>
