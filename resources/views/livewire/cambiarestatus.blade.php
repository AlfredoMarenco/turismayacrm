                ...
                <div
                    ...
                    <div>
                        <div class="mt-3 text-center sm:mt-5">
                            <h1 class="text-lg font-medium leading-6 text-gray-900" id="modal-title">Introduce la
                        ...
                        <div class="mt-2 sm:mt-5">
                            <div>
                                <div>
                                    <label for="email"
                                        class="block text-sm font-medium text-gray-700">Tipo de pago</label>
                                    <select id="estatus" name="location"
                            ...
                            <div>
                                <div class="mt-5 mb-4">
                                    ...
                                    <div class="relative mt-1 rounded-md shadow-sm">
                                        ...
                                        <input type="text" name="comentario-pago" id="comentario-pago"
                                            class="block w-full rounded-md border-gray-300 pl-3 pr-12 focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm"
                                            placeholder="Escribe información relevante sobre el tipo de pago" aria-describedby="price-currency">
