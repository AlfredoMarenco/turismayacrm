                        ...
                        <div class="grid grid-cols-10 gap-4">
                            ...
                            <div class="col-span-5">
                              ...
                              <div class="relative mt-1 rounded-md shadow-sm">
                                  <input type="text" name="text" id="name" class="block w-full rounded-md border-gray-300 pl-3 focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm" placeholder="Josué Gutierrez">
                              </div>
                            ...
                            <div class="col-span-3">
                              ...
                              <div class="relative mt-1 rounded-md shadow-sm">
                                  ...
                                  <input type="email" name="email" id="email" class="block w-full rounded-md border-gray-300 pl-3 focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm" placeholder="Número de identificación">
                              </div>
                            </div>
