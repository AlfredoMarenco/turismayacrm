                ...
                <div
                    ...
                    <div>
                        <div class="mt-3 text-center sm:mt-5">
                            <h1 class="text-lg font-medium leading-6 text-gray-900" id="modal-title">Introduce la información requerida</h1>
                        </div>
                        <div class="mt-2 sm:mt-5">
                            <div>
                                <div>
                                    <label for="email" class="block text-sm font-medium text-gray-700">Descripción</label>
                                    <div class="mt-1">
                    ...
                    <div class="mt-5 sm:mt-6 sm:grid sm:grid-flow-row-dense sm:grid-cols-2 sm:gap-3">
                        <button type="button"
                            class="inline-flex w-full justify-center rounded-md border border-transparent bg-blue-900 px-4 py-2 text-base font-medium text-white shadow-sm hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 sm:col-start-2 sm:text-sm">Editar concepto</button>
                        <button type="button"
