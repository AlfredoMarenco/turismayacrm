                        ...
                        <form class="flex h-full flex-col overflow-y-scroll bg-white shadow-xl">
                            <div class="bg-blue-900 py-6 px-4 sm:px-6">
                                <div class="flex items-center justify-between">
                                    <h2 class="text-lg font-medium text-white" id="slide-over-title">Agregar o modificar chofer</h2>
                                    ...
                                    <div class="pt-1">
                                        <div class=" grid grid-cols-1 gap-y-6 gap-x-4 sm:grid-cols-6">
                                            <div class="sm:col-span-6">
                                                ...
                                                <div class="mt-1">
                                                    <input type="text" name="nombre-chofer" id="nombre-chofer"
                                            ...
                                            <div class="sm:col-span-6">
                                                ...
                                                <div class="mt-1">
                                                    <input type="text" name="edad-chofer" id="edad-chofer"
                                            ...
                                            <div class="sm:col-span-6">
                                                ...
                                                <div class="relative mt-1 rounded-md shadow-sm">
                                                    <input type="tel" name="telefono-chofer" id="telefono-chofer"
                                                        class="block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm">
                                                </div>
                                            </div>
                                            ...
                                            <div class="sm:col-span-6">
                                                <label for="rfc"
                                                    class="block text-sm font-medium text-gray-700">Vigencia de licencia</label>
                                                <div class="relative mt-1 rounded-md shadow-sm">
                                                    <input type="text" name="v-licencia" id="v-licencia"
                                                        class="block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm">
                                                </div>
                                            </div>
                                            ...
                                            <div class="sm:col-span-6">
                                                <label for="rfc"
                                                    class="block text-sm font-medium text-gray-700">Exámen psicofísico</label>
                                                <div class="relative mt-1 rounded-md shadow-sm">
                                                    <input type="text" name="psicofisico" id="psicofisico"
                                                        class="block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm">
                                                </div>
                                            </div>
