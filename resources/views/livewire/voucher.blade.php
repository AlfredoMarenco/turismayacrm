        ...
        <div class="lg:flex lg:items-center lg:justify-between">
            <div class="md:pl-5 lg:pl-8 min-w-0 flex-1">
                <h2 class="text-2xl font-bold leading-7 text-gray-900 sm:truncate sm:text-3xl sm:tracking-tight">
                    Crear Voucher: <span>Jane Cooper</span></h2>
                    ...
                    <ol role="list" class="flex space-x-4 rounded-md bg-white px-6 shadow">
                        ...
                        <li class="flex">
                            <div class="flex items-center">
                                ...
                                <a href="#"
                                    class="ml-4 text-sm font-medium text-gray-500 hover:text-gray-700">Crear voucher</a>
                            </div>
                        </li>
    ...
    <div class="py-4">
        ...
        <div class="py-42px-4 sm:px-6 lg:px-8">
            ...
            <div class="mt-3 flex flex-col">
                <h5 class="pb-3 text-2xl font-bold leading-7 text-gray-900 sm:truncate sm:text-3xl sm:tracking-tight">
                    ITINERARIO</h5>
                                ...
                                <tbody class="divide-y divide-gray-200 bg-white">
                                    <tr>
                                        ...
                                        <td class="whitespace-nowrap px-3 py-4 text-sm text-gray-500">
                                            Camioneta</td>
                                        <td class="whitespace-nowrap px-3 py-4 text-sm text-gray-500">
                                            Salida de casa de doña Guiomara</td>
                                        <td class="whitespace-nowrap px-3 py-4 text-sm text-gray-500">
