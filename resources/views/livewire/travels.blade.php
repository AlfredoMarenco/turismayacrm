                    ...
                    <div class="py-42px-4 sm:px-6 lg:px-8">
                        ...
                        <div class="grid grid-cols-10 gap-4">
                            <div class="col-span-2">
                                ...
                                <select wire:model="paginate" class="mt-1 block w-full rounded-md border-gray-300 py-2 pl-3 pr-10 text-base focus:border-indigo-500 focus:outline-none focus:ring-indigo-500 sm:text-sm">
                            ...
                            <div class="col-span-4">
                                ...
                                <div class="relative mt-1 rounded-md shadow-sm">
                                    ...
                                    <input type="text" wire:model="name_search" class="block w-full rounded-md border-gray-300 pl-10 focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm" placeholder="Jane Cooper">
                                </div>
                            ...
                            <div class="col-span-4">
                                ...
                                <div class="col-span-2">
                                    <select wire:model="status_search" class="mt-1 block w-full rounded-md border-gray-300 py-2 pl-3 pr-10 text-base focus:border-indigo-500 focus:outline-none focus:ring-indigo-500 sm:text-sm">
                                    ...
                                    <div class="overflow-hidden shadow ring-1 ring-black ring-opacity-5 md:rounded-lg">
                                        <table class="min-w-full divide-y divide-gray-300">
                                            <thead class="bg-gray-50">
                                                <tr>
                                                    <th scope="col" class="py-3.5 pl-4 pr-3 text-left text-sm font-semibold text-gray-500 sm:pl-6">
                                                        NOMBRE</th>
                                            ...
                                            <tbody class="divide-y divide-gray-200 bg-white">
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="relative whitespace-nowrap py-4 pl-3 pr-4 text-right text-sm font-medium sm:pr-6">
                                                        ...
                                                        @endif
                                                        <a wire:click="modalCancelBudget({{ $travel }})" class="text-red-600 hover:text-red-900 cursor-pointer">Cancelar</a>
                                                        @break
                                                        @endswitch
                                                    </td>
                                                </tr>
            ...
            <div class="mt-10">
                <table class="min-w-full divide-y divide-gray-300">
                    ...
                    <tbody class="divide-y divide-gray-200 bg-white">
                        <tr>
                            <td class="whitespace-nowrap px-3 py-4 text-sm text-gray-500">
                                <select wire:model="type" class="w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm">
                        ...
                        <tr>
                            ...
                            <td class="relative whitespace-nowrap py-4 pl-3 pr-4 text-right text-sm font-medium sm:pr-6">
                                <a wire:click="editSettlement({{ $settlement }})" class="text-blue-600 hover:text-indigo-900 cursor-pointer">Editar</a>
                                <a wire:click="modalDeleteSettlement({{ $settlement }})" class="text-red-600 hover:text-red-900 cursor-pointer">Eliminar</a>
                            </td>
                        </tr>
                        @endforeach
                    </tbody>
        ...
        <x-jet-dialog-modal wire:model="modal_edit_settlement">
            ...
            <x-slot name="content">
                <div class="mb-2">
                    ...
                    <select wire:model="editFormSettlement.type" class="w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm">
                        <option value="" disabled>-Selecciona una opcion-</option>
                        <option value="1">Salario</option>
                        <option value="2">Viaticos</option>
                        <option value="3">Casetas y/o Puentes</option>
                        ...
                        <div class="relative transform overflow-hidden rounded-lg bg-white px-4 pt-5 pb-4 text-left shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-lg sm:p-6">
                            <div>
                                <div class="mt-1 text-center sm:mt-5">
                                    ...
                                    <div class="mt-4">
                                        <textarea rows="4" wire:model="message" class="block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm" placeholder="Escribe un mensaje"></textarea>
                                    </div>
                                    @error('message')
                                    <span class="text-red-500 text-center">{{ $message }}</span>
                                    @enderror
                            ...
                            <div class="mt-3">
                                ...
                                <div class="mt-1 ">
                                    <input type="number" wire:model="percentage_refund" class="block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm" placeholder="Ejemplo: 40" aria-describedby="email-optional">
                                </div>
                            </div>
                            <div class="mt-3">
                                ...
                                <div class="relative mt-1 rounded-md shadow-sm">
                                    ...
                                    <div type="text" class="block w-full rounded-md border-gray-300 pl-7 pr-12 focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm">
                            ...
                            <div class="mt-5 sm:mt-6">
                                <button type="button" wire:click="cancelBudget" class="inline-flex w-full justify-center rounded-md border border-transparent bg-blue-900 px-4 py-2 text-base font-medium text-white shadow-sm hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 sm:text-sm">
                                    Finalizar
                                </button>
                                <button type="button" wire:click="$set('modal_cancel_travel',false)" class="mt-2 inline-flex w-full justify-center rounded-md border border-transparent bg-red-500 px-4 py-2 text-base font-medium text-white shadow-sm hover:bg-red-600 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 sm:text-sm">
                                    Cancelar
                                </button>
                            </div>
                        </div>
