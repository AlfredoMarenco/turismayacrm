    ...
    <main>
        ...
        @if ($modal_liquidate_travel)
            ...
            <x-jet-dialog-modal wire:model="modal_edit_settlement">
                ...
                <x-slot name="footer">
                        <div class="">
                            <x-jet-danger-button class="mx-2" wire:click="$set('modal_edit_settlement',false)">Cancelar</x-jet-danger-button>
            ...
            <x-jet-confirmation-modal wire:model="modal_delete_settlement">
                ...
                <x-slot name="footer">
                    <x-jet-danger-button class="mx-2" wire:click="$set('modal_delete_settlement',false)">Cancelar</x-jet-danger-button>
                                ...
                                <div class="mt-3">
                                    ...
                                    <div class="relative mt-1 rounded-md shadow-sm">
                                        ...
                                        <div type="text" name="monto-pagado" id="monto-pagado"
                                            ...
                                            placeholder="0.00" aria-describedby="price-currency">{{ $total_paid }}
                                        </div>
                                        <div
