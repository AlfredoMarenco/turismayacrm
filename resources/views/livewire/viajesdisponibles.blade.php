<div>
    <div class="px-4 sm:px-0 divide-x">
        <h2 class="text-lg font-medium text-gray-900">Viajes</h2>
    </div>
                ...
                <div class="flex items-center py-5 px-4 sm:py-6 sm:px-0">
                    <div class="flex min-w-0 flex-1 items-center">
                        ...
                        <div class="min-w-0 flex-1 px-4 md:grid md:grid-cols-2 md:gap-4">
                            <div>
                                <p class="truncate text-sm font-medium text-blue-900">Cancún - CDMX</p>
                            ...
                            <div class="hidden md:block">
                                <div>
                                    <p class="text-sm text-gray-900">
                                        Fecha de viaje
                                        <time datetime="2020-07-01T15:34:56">03 de Enero 2023</time>
                                    </p>
                                    <p class="mt-2 flex items-center text-sm text-gray-500">
    ...
    <nav class="flex items-center justify-between border-t border-gray-200 px-4 sm:px-0"
        ...
        <div class="hidden md:-mt-px md:flex">
            <a href="#"
                class="inline-flex items-center border-t-2 border-transparent px-4 pt-4 text-sm font-medium text-gray-500 hover:border-gray-200 hover:text-gray-700">1</a>
            ...
            <a href="#"
                class="inline-flex items-center border-t-2 border-transparent px-4 pt-4 text-sm font-medium text-gray-500 hover:border-gray-200 hover:text-gray-700">3</a>
            <a href="#"
                class="inline-flex items-center border-t-2 border-transparent px-4 pt-4 text-sm font-medium text-gray-500 hover:border-gray-200 hover:text-gray-700">4</a>
            <a href="#"
                class="inline-flex items-center border-t-2 border-transparent px-4 pt-4 text-sm font-medium text-gray-500 hover:border-gray-200 hover:text-gray-700">5</a>
            <a href="#"
                class="inline-flex items-center border-t-2 border-transparent px-4 pt-4 text-sm font-medium text-gray-500 hover:border-gray-200 hover:text-gray-700">6</a>
        </div>
