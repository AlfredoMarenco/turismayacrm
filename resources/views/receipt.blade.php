            ...
            <div class="pos-container">
                <div class="info-cabecera">
                    <p>
                        ...
                        <span style="font-weight: bold; color:#a8bd3a;">Referencia:</span> <span style="color:#a8bd3a;">COT-{{ $budget->id }}</span><br>
            ...
            <table class="table-presupuesto" style="width: 100%">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td style="min-height: 40px; display: flex; flex-direction: column; justify-content: center; padding-left: 15px; padding-top: 10px; padding-bottom: 10px;">
                        ...
                        <td style="width: 150px; text-align: center; ">
                            @foreach ($vehicle->concepts as $concept)
                            <p style="height: 75px; display: flow;  padding-left: 15px; padding-top: 10px; padding-bottom: 10px; font-weight: bold;"><span>$</span>{{ number_format($concept->total, 2) }} <span>MXN</span></p>
                            <!--  <ul>
            ...
            <div class="flex-container" >
                ...
                <table>
                    <tbody>
                        <tr>
                            <td><b>Subtotal</b></td>
                            <td style="text-align: right;"><span>{{ number_format($vehicle->totalWithOutTax(), 2) }}</span> MXN </td>
                        </tr>
                        <tr>
                            <td><b>Impuestos</b></td>
                            <td style="text-align: right;"> <span>{{ number_format($vehicle->totalTax(), 2) }}</span> MXN </b></td>
                        </tr>
